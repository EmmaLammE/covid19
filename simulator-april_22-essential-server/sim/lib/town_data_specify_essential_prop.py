...
def generate_population(bbox, population_per_age_group, density_files=None, tile_level=16, seed=None, density_site_loc=None,essential_prop_per_age_group=None,site_type=None,essential_type=None): 
...
#             num_essential_workers_per_site = np.floor(num_essential_workers / num_essential_type).astype('int').tolist()
            prob_essential_workers_per_site = np.array([1/num_essential_type]*num_essential_type) # to be discussed
