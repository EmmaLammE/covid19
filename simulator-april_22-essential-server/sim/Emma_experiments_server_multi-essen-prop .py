...
essential_to_total_ratio_list = [0.0,0.1,0.3,0.5]
summaries_ = []
for essential_to_total_ratio in essential_to_total_ratio_list:
    ...
    if __name__ == '__main__':
        ...
        mob_settings = 'lib/essential-prop'+str(essential_to_total_ratio)+'_supermarket_settings_100_20.pk'
...
save_summary(summaries_SD_6, 'essential-prop'+str(essential_to_total_ratio_list)+'_comp'+str(p_essential)+'_repeats'+str(random_repeats)+'_'+mob_setting)
