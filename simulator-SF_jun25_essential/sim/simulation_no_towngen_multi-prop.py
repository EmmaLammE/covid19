...
essential_to_total_pop_ratio_list = [0.0, 0.1, 0.3, 0.5]
for essential_to_total_pop_ratio in essential_to_total_pop_ratio_list:
    mob_settings = 'sf_type0_prop'+str(essential_to_total_pop_ratio)+'_ds100.pk'
